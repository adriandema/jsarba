$('body').append("<div id='fff' title='marcar dominios automotor' class='dlg' style='position:absolute;  top: 20px;    left: 20px; width;50% z-index: 100; background-color: rgba(150,150,150,.5);'>"+
